...
"use strict"
function makeArray(filterArray, secondArray, maxLength) {
if (!Array.isArray(filterArray) || !Array.isArray(secondArray)) {
...
if (!Number.isInteger(maxLength)) {
    ...
    const newArray = filterArray.concat(secondArray); //обєдення двох масивів
